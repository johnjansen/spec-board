...
- Python 3.11+ (backend), JavaScript ES6+ (frontend) (005-markdown-editor)
- File-based (local filesystem, read/write markdown files in specs/ directories) (005-markdown-editor)
...
## Recent Changes
- 005-markdown-editor: Added Python 3.11+ (backend), JavaScript ES6+ (frontend)
